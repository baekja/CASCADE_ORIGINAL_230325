# import os 
# os.chdir("CASCADE/code/predicting_model/C/ExpNN-dft")
...
mols = []
with gzip.open('../../../../data/CHESHIRE/CHESHIRE_probe.sdf.gz', 'r') as sdfile:  # CHESHIRE 데이터로 수정
...
df = pd.read_csv('../../../../data/CHESHIRE/CHESHIRE_probe.csv.gz', index_col=0)
#only choose C and H
